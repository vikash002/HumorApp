...
begin
  ...
  ary_topic = ['cute', 'geeky', 'girl','meme', 'wtf']
  ...
  #for i in 0..ary_topic.length
    ...
    file1 = File.new(ary_title[0])
    file2 = File.new(ary_link[0])
    ...
    while line1 = file1.gets
      ...
      ch = "INSERT INTO cutes (title, url,created_at, updated_at, user_id) VALUES (?,?,?,?,?)"
